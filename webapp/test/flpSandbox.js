		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#fbpprestigefbpdeclaration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fbpprestigefbpdeclaration-display": {
								"semanticObject": "fbpprestigefbpdeclaration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fbp.prestige.fbpdeclaration",
									"url": sap.ui.require.toUrl("fbp/prestige/fbpdeclaration")
								}
							}
						}
					}
